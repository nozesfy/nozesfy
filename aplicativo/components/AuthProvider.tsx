...
// Componente de imagem otimizado do Next.js (lazy loading, WebP automático, etc.)
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // Enquanto a sessão está carregando, mostra uma tela de loading com o logo animado
  // Isso evita que o usuário veja o conteúdo "piscando" antes da sessão ser verificada
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="flex flex-col items-center">
          {/* Logo com animação de pulso enquanto carrega */}
          <div className="relative w-48 h-16 mb-6 animate-pulse">
            <Image
              ...
              priority // Carrega com prioridade para aparecer o mais rápido possível
            />
          </div>
  ...
  // Quando a sessão já foi carregada, renderiza os componentes filhos dentro do Provider
  // Todos os componentes dentro de AuthProvider terão acesso ao contexto via useAuth()
  return (
